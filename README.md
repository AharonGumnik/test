...
[1. General Overview](#general-overview)<br>
2. [Limitations](#2.-limitations)<br>
3. [APIs – General Information](#integration)<br>
    [3.1. Authentication](#authentication)<br>
    [3.2. Service URI](#service-uri)<br>
    [3.3. API Version](#api-version)<br>
4. [Model Basic](#model-basic)<br>
	[4.1. Create Model](#create-a-model)<br>
	[4.2. Get Model](#get-model)<br>
	[4.2 Get All Models](#get-all-models)<br>
	[4.3. Update Model](#update-model)<br>
	[4.4. Delete Model](#delete-model)<br>
5. [Model Advanced](#model-advanced)<br>
	[5.1. Model Data Insight](#model-data-insight)<br>
	[5.2. Model Insight](#model-insight)<br>
	[5.3. Get Model Sample](#model-sample)<br>
6. [Model Business Rules](#model-advanced)<br>
	[6.1. Get Model Rules](#get-model-rules)<br>
	[6.2. Add Rule](#add-model-rule)<br>
	[6.3. Delete Rule](#delete-rule)<br>
	[6.4. Delete All Rules](#delete-all-rules)<br>
7. [Catalog](#catalog)<br>
	[7.1. Import catalog data](#import-catalog-data)<br>
	[7.2. Get Catalog](#get-catalog)<br>
	[7.3. Get Catalog Items by Token](#get-catalog-by-token)<br>
8. [Usage Data](#usage-data)<br>
	[8.1. Import usage data](#import-usage-data)<br>
	[8.1.1. Uploading file](#uploading-file)<br>
	[8.1.2. Using data acquisition](#using-data-acquisition)<br>
	[8.2. List Model Usage Files](#list-model-usage-files)<br>
	[8.3. Get Usage Statistics](#get-usage-statistics)<br>
	[8.4. Get Usage File Sample](#get-usage-file-sample)<br>
	[8.5. Get Model Usage File](#get-model-usage-file)<br>
	[8.6. Delete Usage File](#delete-usage-file)<br>
	[8.7. Delete All Usage Files](#delete-all-usage-files)<br>
9. [Build](#build)<br>
	[9.1. Build a model](#build-a-recommendation-model)<br>
	[9.2. Get Builds Status of a Model](#get-builds-status-of-a-model)<br>
	[9.3. Get Builds Status of a User](#get-builds-status-of-a-user)<br>
	[9.4. Delete Build](#delete-build)<br>
	[9.5. Cancel Build](#cancel-build)<br>
	[9.6. Get Build Parameters](#get-builds-parameters)<br>
10. [Recommendation](#recommendation)<br>
	[10.1. Get Recommendations](#get-recommendations)<br>
11. [Notifications](#notifications)<br>
	[11.1. Get Notifications](#get-notifications)<br>
	[11.2. Delete Model Notifications](#delete-model-notifications)<br>
	[11.3. Delete User Notifications](#delete-user-notifications)<br>
12. [Legal](#legal)<br>
